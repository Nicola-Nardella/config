...
alias showPasswordTechspace="security find-generic-password -ga 'Techspace' | grep 'password:'"
alias showPasswordHome="security find-generic-password -ga 'VM3418175' | grep 'password:'"
...
source /Users/NicolaNardella/.npm-run.plugin.zsh/npm-run.plugin.zsh
